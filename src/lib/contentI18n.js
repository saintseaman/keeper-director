...
export const SOUND_TITLES = {
  ...
  ocean_waves: { ru: 'Волны', ua: 'Океанські хвилі' },
  ...
  library_quiet: { ru: 'Библиотека', ua: 'Тиха бібліотека' },
  ...
  underground: { ru: 'Под землёй', ua: 'Глибоко під землею' },
  ...
  elder_thing: { ru: 'Древние', ua: 'Присутність Прадавніх' },
  ...
  heartbeat_slow: { ru: 'Сердце (медл.)', ua: 'Повільне серцебиття' },
  heartbeat_fast: { ru: 'Сердце (быстр.)', ua: 'Шалене серцебиття' },
  scratching: { ru: 'Царапанье', ua: 'Дряпання' },
  distant_scream: { ru: 'Далёкий крик', ua: 'Далекий крик' },
  eerie_music_box: { ru: 'Шкатулка', ua: 'Музична скринька' },
  ...
  distortion: { ru: 'Искажение', ua: 'Викривлення реальності' },
  ...
  multiple_voices: { ru: 'Хор голосов', ua: 'Безліч голосів' },
