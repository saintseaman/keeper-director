...
export const SCENE_AXES = [
  {
    ...
    values: [
      ...
      { id: 'suburb', label: 'Пригород', icon: Home, kw: ['suburb', 'village', 'house', 'home', 'пригород', 'деревн', 'дом', 'село'] },
      { id: 'manor', label: 'Поместье', icon: Landmark, kw: ['manor', 'mansion', 'estate', 'villa', 'поместь', 'усадьб', 'особняк', 'имение'] },
      { id: 'tavern', label: 'Таверна', icon: Beer, kw: ['tavern', 'inn', 'pub', 'bar', 'cafe', 'restaurant', 'таверн', 'бар', 'кафе', 'трактир', 'кабак'] },
      ...
      { id: 'library', label: 'Библиотека', icon: Library, kw: ['library', 'archive', 'study', 'arkham', 'miskatonic', 'библиотек', 'архив', 'кабинет', 'читальн'] },
      { id: 'asylum', label: 'Лечебница', icon: Brain, kw: ['asylum', 'sanatorium', 'hospital', 'madhouse', 'лечебниц', 'психиатр', 'больниц', 'санатор', 'клиник'] },
      { id: 'temple', label: 'Храм', icon: Landmark, kw: ['church', 'temple', 'cathedral', 'shrine', 'bell', 'церков', 'храм', 'собор', 'дзвон', 'святилищ'] },
      { id: 'ruins', label: 'Руины', icon: Pentagon, kw: ['ruins', 'rlyeh', 'cyclopean', 'ancient city', 'руин', 'рльех', 'развалин', 'древн', 'обломк'] },
      { id: 'university', label: 'Университет', icon: BookOpen, kw: ['university', 'college', 'academy', 'miskatonic', 'университет', 'академ', 'колледж', 'кафедр'] },
      { id: 'dungeon', label: 'Подземелье', icon: Mountain, kw: ['dungeon', 'cave', 'crypt', 'tomb', 'cellar', 'basement', 'underground', 'подземель', 'пещер', 'склеп', 'подвал', 'катакомб'] },
    ],
  },
  {
    id: 'action',
