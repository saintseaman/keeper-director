...
export const SCENE_AXES = [
  {
    ...
    color: 'sky',
    values: [
      { id: 'city', label: 'Город', icon: Building2, image: 'https://images.unsplash.com/photo-1477959858617-67f85cf4f1df?w=200&q=80', kw: ['city', 'town', 'street', 'urban', 'город', 'улиц', 'місто'] },
      { id: 'suburb', label: 'Пригород', icon: Home, image: 'https://images.unsplash.com/photo-1518780664697-55e3ad937233?w=200&q=80', kw: ['suburb', 'village', 'house', 'home', 'пригород', 'деревн', 'дом', 'село'] },
      { id: 'manor', label: 'Поместье', icon: Landmark, image: 'https://images.unsplash.com/photo-1464146072230-91cabc968dbd?w=200&q=80', kw: ['manor', 'mansion', 'estate', 'villa', 'поместь', 'усадьб', 'особняк', 'имение'] },
      { id: 'tavern', label: 'Таверна', icon: Beer, image: 'https://images.unsplash.com/photo-1510626176961-4b57d4fbad03?w=200&q=80', kw: ['tavern', 'inn', 'pub', 'bar', 'cafe', 'restaurant', 'таверн', 'бар', 'кафе', 'трактир', 'кабак'] },
      { id: 'forest', label: 'Лес', icon: Trees, image: 'https://images.unsplash.com/photo-1448375240586-882707db888b?w=200&q=80', kw: ['forest', 'jungle', 'wood', 'tree', 'swamp', 'nature', 'лес', 'ліс', 'природ', 'дик', 'джунгл', 'болот'] },
      { id: 'sea', label: 'Море', icon: Waves, image: 'https://images.unsplash.com/photo-1505118380757-91f5f5632de0?w=200&q=80', kw: ['sea', 'ocean', 'ship', 'harbor', 'dock', 'beach', 'wave', 'river', 'water', 'море', 'океан', 'хвил', 'річк', 'корабл', 'порт', 'пляж'] },
      { id: 'library', label: 'Библиотека', icon: Library, image: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=200&q=80', kw: ['library', 'archive', 'study', 'arkham', 'miskatonic', 'библиотек', 'архив', 'кабинет', 'читальн'] },
      { id: 'asylum', label: 'Лечебница', icon: Brain, image: 'https://images.unsplash.com/photo-1519999482648-25049ddd37b1?w=200&q=80', kw: ['asylum', 'sanatorium', 'hospital', 'madhouse', 'лечебниц', 'психиатр', 'больниц', 'санатор', 'клиник'] },
      { id: 'temple', label: 'Храм', icon: Landmark, image: 'https://images.unsplash.com/photo-1548438294-1ad5d5f4f063?w=200&q=80', kw: ['church', 'temple', 'cathedral', 'shrine', 'bell', 'церков', 'храм', 'собор', 'дзвон', 'святилищ'] },
      { id: 'ruins', label: 'Руины', icon: Pentagon, image: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=200&q=80', kw: ['ruins', 'rlyeh', 'cyclopean', 'ancient city', 'руин', 'рльех', 'развалин', 'древн', 'обломк'] },
      { id: 'university', label: 'Университет', icon: BookOpen, image: 'https://images.unsplash.com/photo-1562774053-701939374585?w=200&q=80', kw: ['university', 'college', 'academy', 'miskatonic', 'университет', 'академ', 'колледж', 'кафедр'] },
      { id: 'dungeon', label: 'Подземелье', icon: Mountain, image: 'https://images.unsplash.com/photo-1520637102912-2df6bb2aec6d?w=200&q=80', kw: ['dungeon', 'cave', 'crypt', 'tomb', 'cellar', 'basement', 'underground', 'подземель', 'пещер', 'склеп', 'подвал', 'катакомб'] },
    ],
  },
  {
    id: 'action',
