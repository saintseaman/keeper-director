...
const BASE_VOLUME = 1.0; // громкость одиночного слоя (полная — балансом управляет микшер)
...
export function layerVolume(count) {
  return BASE_VOLUME; // 1.0 — без деления на число слоёв, каждый слой стартует на максимуме
}
